...
/**
 *
 * @author tomyv Un profesor particular está dando cursos para grupos de cinco
 * alumnos y necesita un programa para organizar la información de cada curso.
...
public class Curso {
    ...
    public Curso(String nombreCurso, int cantidadHorasPorDia, int cantidadDiasPorSemana, boolean turno, double precioPorHora) {

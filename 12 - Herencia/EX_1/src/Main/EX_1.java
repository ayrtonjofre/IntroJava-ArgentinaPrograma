 ...
 * fecha de devolución, la posición del amarre y el barco que lo ocupará.ok
 *
 ...
 * • Potencia en CV y número de camarotes para yates de lujo. ok
 *
 ...
 *
 * En los veleros se suma el número de mástiles, en los barcos a motor se le
 * suma la potencia en CV y en los yates se suma la potencia en CV y el número
 * de camarotes.
 *

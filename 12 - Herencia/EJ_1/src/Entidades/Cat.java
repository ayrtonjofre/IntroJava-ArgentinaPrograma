...
public class Cat extends Animal {
    ...
    public Cat(String brandFood, String name, Integer age, String type, String colour, Size siz) {
    ...
    public Animal createAnimal() {
        ...
        System.out.println("BRAND FOOD");
        this.brandFood = sc.next();
        return new Cat(brandFood,name,age,type,colour, siz);
    }

    @Override
    public String toString() {
        return super.toString() + " Brand: " + brandFood; 

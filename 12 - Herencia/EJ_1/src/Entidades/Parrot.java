...
public class Parrot extends Animal {
    ...
    public Parrot(Integer size, String name, Integer age, String type, String colour, Size siz) {
    ...
    public Animal createAnimal() {
        ...
        System.out.println("PARROT'S SIZE");
        this.size = sc.nextInt();
        return new Parrot(size,name,age,type,colour,siz);
    }
